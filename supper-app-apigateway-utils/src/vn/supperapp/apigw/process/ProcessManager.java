 ...
 */
package vn.supperapp.apigw.process;

import vn.supperapp.apigw.process.business.BaseProcessBusiness;
import vn.supperapp.apigw.process.confgis.ExecutorTaskConfigInfo;
import vn.supperapp.apigw.process.confgis.ProcessConfigInfo;
...
public class ProcessManager {
    ...
    private static final String PROCESS_CONFIG_PATH = "../etc/config-process.yml";
