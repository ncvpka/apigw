...
@Entity
@Table(name = "ISSUE_LOG_WORK", schema = "SUPPERAPP")
public class IssueLogWork {
    public static final String TABLE_NAME = "ISSUE_LOG_WORK";
    public static final String SEQ_NAME = "ISSUE_LOG_WORK_SEQ";

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "issue_log_work_generator")
    @SequenceGenerator(name = "issue_log_work_generator", allocationSize = 1, sequenceName = "ISSUE_LOG_WORK_SEQ")
    @Column(name = "ID")
    private Long id;
    @Basic
    ...
    public boolean equals(Object o) {
        ...
        IssueLogWork that = (IssueLogWork) o;
