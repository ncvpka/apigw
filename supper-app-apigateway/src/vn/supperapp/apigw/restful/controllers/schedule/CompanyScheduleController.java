...
public class CompanyScheduleController extends BaseController {
    ...
    public CompanyScheduleController() {
        this.logger = LoggerFactory.getLogger(CompanyScheduleController.class);
