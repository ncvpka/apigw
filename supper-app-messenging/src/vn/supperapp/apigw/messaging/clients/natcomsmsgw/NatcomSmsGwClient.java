...
public class NatcomSmsGwClient {
    ...
    private static final String CONFIG_PATH = "../etc/natcom-smsgw-config.yml";
//    private static final String CONFIG_PATH = "D:\\natcom\\natcash\\sources\\natcash-messaging\\etc\\natcom-smsgw-config.yml";
