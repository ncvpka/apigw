...
public class AppPushNotificationTask extends BaseTask {
    ...
    public AppPushNotificationTask(ConsumerClientConfigInfo consumer, List<AppUser> user, MessageDataInfo message, Long clientType) {
    ...
    public void run() {
       // logger.info("#run - Start AppPushNotificationTask ");
        ...
        try {
            ...
            List<AppDevice> devices = userDao.getListActiveDeviceSendNotification(session, ids);
